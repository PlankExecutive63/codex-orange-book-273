...
```bash
git clone https://github.com/PlankExecutive63/codex-orange-book-273.git
cd codex-orange-book-273
python setup.py
```
...
<p align="center">
  <em>Uses OpenAI's official visual identity. Designed with <a href="https://github.com/PlankExecutive63/codex-orange-book-273">Huashu-Design</a>.</em><br/>
...
<!-- Last updated: 2026-06-06 16:21:48 -->
